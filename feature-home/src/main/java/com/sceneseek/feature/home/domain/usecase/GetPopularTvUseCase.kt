...
class GetPopularTvUseCase @Inject constructor(private val repository: TvRepository) {
    operator fun invoke(page: Int = 1): Flow<Result<List<TvShow>>> = repository.getPopularTv(page)
}
